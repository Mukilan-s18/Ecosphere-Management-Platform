...
export default function WrappedPage() {
  ...
  return (
    <div className="p-8 space-y-6 animate-in fade-in duration-500">
      ...
      {/* Slide Container */}
      <div
        className={`relative rounded-2xl bg-gradient-to-br ${gradients[currentSlide]} border border-slate-800 overflow-hidden min-h-[480px] flex flex-col items-center justify-center transition-opacity duration-300 ${animating ? "opacity-0" : "opacity-100"}`}
      >
        {/* Decorative blobs */}
